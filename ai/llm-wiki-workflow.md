...
| **Wiki 层** | 文献笔记、调研、工作汇报、概念页、实体页、论文草稿 | AI | AI 增量创建/维护页面与交叉引用 |
...
- **work report（工作汇报）**：一次面向导师或合作团队的周期性汇报，落在 `work-reports/<对象>/`；同一页面持续维护会前技术底稿、会后研究结论和行动项。
...
- **工作汇报生命周期与边界**：工作汇报页使用 `preparing → reported → follow-up-done`；未实际汇报不得标为 `reported`。页面只保存技术底稿、研究结论和行动项，真实消息、逐字交流、约见与关系状态由对应沟通仓库维护，项目任务实时状态以项目仓库为准。
