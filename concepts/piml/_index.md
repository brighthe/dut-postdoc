...
| [[../../research/piml-matrix-free-gpu/piml-research-guide]] | **PIML 研究指南**：研究目标、学习对象边界、统一比较契约与证据入口。 |

#### 2. 论文证据与文献事实源 (dut-postdoc 知识库)
| 入口 | 职责与呈现内容 |
|---|---|
| [[../../literature/topopt/piml/translations/Huang2023-PIML-substructure-zh]] | **Huang 2023 论文中文精译**：子结构缩聚 PIML 原始论文完整中文翻译，含数学公式 1~18、MBB 梁算例（Section 4.1）与拓扑优化流程。 |
| [[../../literature/topopt/piml/translations/Huang2023-PIML-substructure-zh]] | **Huang 2023 论文阅读笔记**：论文核心创新点、算法骨架与消融实验结构化笔记。 |
...
| 页面 | 一句话概括 |
|---|---|
| [[../../research/piml-matrix-free-gpu/piml-research-guide]] | 以 Problem-Independent 局部力学表示学习为项目主线，服务 PIML 局部表示线的证据综合与模型选型 |
...
- [[../../literature/topopt/mmc-mmv/translations/Lei2018-machinelearningdriven-zh]] — 机器学习 + MMC 实时拓扑优化，作为问题相关直接预测范式的前史。
- [[../../literature/topopt/piml/translations/Huang2022-problemindependentmachine-zh]] — Huang 2022，PIML + EMsFEM 形函数。
- [[../../literature/topopt/piml/translations/Huang2023-PIML-substructure-zh]] — Huang 2023，PIML + 子结构形函数 / 缩聚刚度矩阵。
- [[../../literature/topopt/piml/translations/Huang2024-PIML-datafree-zh]] — Huang 2024，mechanics-based data-free PIML。
- [[../../literature/topopt/gpu-hpc/translations/Ma2026-highperformanceparallel-zh]] — Ma 2026，并行 PIML 与按需预测 / 释放。
...
- 数学事实分别由 [[piml-substructural]]（PIML 子结构算子）与 [[../substructural-condensation]]（Schur 补缩聚推导）维护，单篇论文事实由 `literature/` 维护，阶段性讨论与汇报由 `entities/` 维护。
- 不在概念页维护当前任务状态、实施阶段或预计交付日期；这些由 [[../../research/piml-matrix-free-gpu/piml-research-guide]] 维护。
