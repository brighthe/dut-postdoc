...
> 原笔记：[[../Huang2022-problemindependentmachine]]
> Zotero 条目： zotero://select/library/items/TSLB5VAR
> PDF 附件： zotero://open-pdf/library/items/TSLB5VAR
> 说明： 本页用于放置 Huang 2022 的完整中文译稿。
...
* Better BibTeX key: `Huang2022-problemindependentmachine`
* Zotero item key: `TSLB5VAR`
...
与经典 SIMP 方法对应的结果相比，$t_{\mathrm{it}}$ 分别降低了 $75.77\%$（对于 $10\times 10$ 情形）和 $74.52\%$（对于 $m=5\times 5$ 情形）。在本文提出的 PIML 增强方法中，每次迭代中 OC 更新所消耗的时间占据主要部分。![[Pasted image 20260507084650.png]]
...
<center>表 4：代表性迭代步中的计算时间分解（MBB 梁算例被离散为 2 亿个细分辨率单元）。</center>
