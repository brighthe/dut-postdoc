...
- **PIML 方法提出**
  - [[literature/topology-opt/Huang2022-PIML-universal]] — _Problem-independent machine learning (PIML)-based topology optimization—a universal approach_（ANN + EMsFEM，奠基之作）
