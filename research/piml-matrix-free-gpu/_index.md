...
| PIML 方法、模型选型与历史证据 | [[../technical-lines/piml-research-guide]] |
...
实际启动融合时，应在 [[project-plan]] 和对应软件仓库中冻结算例、接口、指标、停止条件和失败回退；PIML 的局部表示与统一比较契约仍以 [[../technical-lines/piml-research-guide]] 为准，不另建通用融合规范。
...
- [[../technical-lines/piml-research-guide]] — PIML 模型选型原则、局部学习对象边界与证据综合。
- [[../../discussions/guo-xu/_index]] — 郭旭老师工作汇报。
- [[../../discussions/liu-chang/_index]] — 刘畅老师工作汇报。
