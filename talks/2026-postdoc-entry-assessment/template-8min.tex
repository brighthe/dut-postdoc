		...
		\begin{columns}[T, totalwidth=\linewidth]
			...
			\begin{column}{0.62\linewidth}
				...
				\begin{tabular}{@{}l@{\hspace{4pt}}p{\dimexpr\linewidth-1.1cm\relax}@{}}
					\circnum{01} & {\fontsize{7.5}{10.5}\selectfont\sffamily PIML 增强多尺度分析与 Matrix-Free 高性能求解} \\[7pt]
					\circnum{02} & {\fontsize{7.5}{10.5}\selectfont\sffamily MMC/MMV 显式拓扑优化的先进数值分析} \\
				\end{tabular}
