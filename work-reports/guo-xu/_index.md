...
> 本目录保存面向郭旭老师的完整工作汇报材料，包括本次实际要汇报的行政/工作状态摘要、科研与项目进展、合作线索、待请教问题，以及实际汇报后的结论和行动项。真实聊天、约见、原话、完整行政流水和关系信息以 `heliangos/wechat/dalian-university-of-technology-postdoc/teachers/郭旭.md` 为准，不在这里重复维护。
